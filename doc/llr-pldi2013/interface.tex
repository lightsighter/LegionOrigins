...
If the only operations a task will perform on a instance are reductions, a special reduction-only
...
a normal instance or another reduction-only instance.  First, it results
...
Second, a reduction-only instance is often smaller than a normal instance, potentially improving
