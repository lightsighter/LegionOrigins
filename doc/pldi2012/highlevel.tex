...
in a manner similar to a pipelined out-of-order hardware processor, but at
a coarser granularity with tasks corresponding to instructions and
regions corresponding to registers.  There is a pipeline of stages to 
...
as well as the read-write privileges and coherence properties
