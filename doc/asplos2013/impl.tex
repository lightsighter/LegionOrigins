...
that the remote node should be informed when the event triggers.  Arbitrarily many depedent operations on
...
communication.  Whereas events ownership is static, locks may migrate; the {\em creating}
