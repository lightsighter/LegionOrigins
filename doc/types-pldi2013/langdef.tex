...
disjointness of the two physical regions.  Although still a dynamic test, it is performed
...
tasks access aliased regions cannot run concurrently, they may execute in either order, allowing
