...
The final piece is to turn this test into something that can be performed before the subtasks are executed, ideally as efficiently as
possible.  The key to this is the privileges on Legion tasks and their ability to provide bounds on the accesses that may be performed
during execution.  Our non-interference operator is extended to work on privileges and sets of privileges:
$
\begin{array}{l@{}l}
