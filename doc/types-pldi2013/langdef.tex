...
handling this in operational semantics (\cite{CML} is a well-known example) is to use a top-down approach with
small-step semantics and a global view of all
