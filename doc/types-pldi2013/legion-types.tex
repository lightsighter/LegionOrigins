...
partition their data in order to enable parallel execution.
...
of static and dynamic analyses to support reasoning about potential aliasing introduced
by dynamic data partitions with minimal overhead.  We present the novel aspects of the Legion design, 
