...
Recently machine architecture, particularly at the high
...
of distributed memory has become increasingly complex, the placement and movement of dat has
...
limit expressivity but incurs runtime overhead;  examples 
...
the fully dynamic approach permits arbitrary partitioning, but requires 
centralized control logic to perform conflict detection between every pair 
of parallel computations, resulting in runtime overhead that isn
