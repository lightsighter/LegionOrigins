...
parallel programs.  Traditionally, these attempts have taken two approaches.   
...
second approach relies on a dynamic analysis of program data that doesn't
limit expressivity, but incurs runtime overhead.  Examples of this approach 
include transactional memory and thread-level speculation.

These two different approaches illustrate different mechanisms for dealing with
the problem of data aliasing in parallel programs.  The fully static approach outlaws aliasing
