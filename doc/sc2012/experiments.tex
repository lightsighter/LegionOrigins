...
locality at many levels of the memory hierarchy instead of just at the node-level.
...
containing grids of different refinement levels to determine if they overlap or not.  
