...
globally addressable, but relatively slow, ``GASNet memory'' that is accessible
by all nodes.
...
%
% FIXME CUT
% We could put this nice sentence back in if we have space.
%
...
%
% FIXME CUT  
% If we find enough space this sentence and the figure can be reinserted here.
