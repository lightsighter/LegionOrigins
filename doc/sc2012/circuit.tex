...
The  tasks spawned on lines 32-34 are {\em subtasks} of the main
{\tt simulate\_circuit} task. The region arguments to a subtask  must be either regions of, or subregions of, the arguments to its parent task with a subset of the permissions and the same coherence properties.  This restriction plays a central role in our task scheduling algorithm (see Section~\ref{sec:soop}).
