...
The mapping interface has two desirable properties.  First, all mapper
...
Each custom mapper extends the default mapper.  A programmer need only override the functions necessary 
