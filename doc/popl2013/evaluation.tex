...
The dynamic nature of AMR requires that regions can be created and partitioned at runtime.  
...
illegal region accesses caused by a confluence of application bugs and lack of checking.  Many times these corruptions 
