...
then the any descendent of $t_1$ in the task hierarchy is non-interfering
with any descendent of $t_2$.  This theorem is the basis for correct distributed
...
and each partition allocates every element in $R$ to a
...
particular, the required privileges for function calls is checked statically
and region
