...
The next step is to extend noninterference to privileges.  We make
...
that check privileges statically, such as Jade \cite{} and
DPJ \cite{}.  In contrast, Legion checks noninterference of privileges
