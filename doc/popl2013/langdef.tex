...
include booleans, integers, tuples, and pointers annotated with a list
...
what region access privileges and coherence it requires.  Function
...
Core Legion has no subtyping, even for pointers into regions that are part of a 
