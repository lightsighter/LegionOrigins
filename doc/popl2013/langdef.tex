...
%work at runtime.) The consistency of a {\tt read}'s result is trivial for an address in the
...
\begin{proof}
To prove $valid\_interleave(S_0, C, E', \oton{E})$, we need to show the three conditions:
\begin{enumerate}
...
memory \cite{transactionalmemory}.  At the other extreme are systems
...
two cases of interest.  In both  the previous section's
