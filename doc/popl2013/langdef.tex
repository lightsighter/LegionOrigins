...
top-level task of a Legion program begins with a single, empty region from which other
...
checked, but are defered to a point where traces that might be ordered before $E$ are included.)  The $seq\_equiv$
...
that check noninterference statically, such as Jade \cite{Rinard98} and
