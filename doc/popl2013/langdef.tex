...
First, we would like a fallback approach that will always result in a valid interleaving, even if
we lack information about the constituent traces (or perhaps lack the time to analyze it).  The
