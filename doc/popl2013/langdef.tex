...
By Theorem~\ref{thm:parallelexec}, if the runtime can verify $\Phi_1 \#_M \Phi_2$, then 
...
$E_1 \# E_2$ from Lemma~\ref{lem:nonintpriv}, so and therefore $\epsilon_3 \# \epsilon_4$.  Since
this holds for all $\epsilon_3$ in $E_3$ and all $\epsilon_4$ in $E_4$, we have $E_3 \# E_4$.
\end{proof}
