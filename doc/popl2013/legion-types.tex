...
that all memory accesses in Legion are safe.  Futhermore, we prove that
the soundess of our type system enables a scalable hierarchical
scheduling algorithm for Legion programs.  We implement a type checker
for Legion programs and improve performance up to 85\% by eliding
unncessary memory checks.  We demonstrate an implementation of the Legion 
