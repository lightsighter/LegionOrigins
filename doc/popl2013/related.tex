...
a limited repetoire of ways to partition arrays.  Sequoia is a very static language with a single unified hierarchy
...
partition schemes must be decided at compile-time.  Legion also allows 
...
Many efforta use static region systems for  memory management (e.g., \cite{Tofte94, Grossman02}).
...
support the interleaving of effects to non-disjoint regions of memory.
