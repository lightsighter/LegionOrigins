...
def make_plot(show = True, save = True, out_dir="figs/"):
    ...
    coher_48_experiments = read_experiments(48,'coherence_results/')
    coher_96_experiments = read_experiments(96,'coherence_results/')
    print "Orignal results for 48 piece experiments"
    print_experiments(orig_48_experiments, baseline48)
    print "Coherence results for 48 piece experiments"
    print_experiments(coher_48_experiments, baseline48)
    print "Overheads for 48 piece experiments"
    print_overheads(orig_48_experiments,coher_48_experiments)
    print "Original results for 96 piece experiments"
    print_experiments(orig_96_experiments, baseline96)
    print "Coherence results for 96 experiments"
    print_experiments(coher_96_experiments, baseline96)
