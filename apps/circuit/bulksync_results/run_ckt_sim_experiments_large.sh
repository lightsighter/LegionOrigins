...
cat $PBS_NODEFILE | uniq > /nics/d/home/sequoia/mike_legion/region/apps/circuit/bulksync_results//unique_big2.txt
export GASNET_SSH_NODEFILE=/nics/d/home/sequoia/mike_legion/region/apps/circuit/bulksync_results//unique_big2.txt
...
#GASNET_BACKTRACE=1 gasnetrun_ibv -n 16 /nics/d/home/sequoia/mike_legion/region/apps/circuit/ckt_sim -ll:cpu 1 -ll:gpu 3 -ll:dma 2 -ll:zsize 1536 -ll:fsize 1024 -ll:csize 4096 -ll:gsize 1536 -npp 2500 -wpp 16384 -p 48 -l 10 -level 3 -sync 1 1> ckt_sim_48_16_1_3.stdio 2> ckt_sim_48_16_1_3.stderr 
...
#GASNET_BACKTRACE=1 gasnetrun_ibv -n 16 /nics/d/home/sequoia/mike_legion/region/apps/circuit/ckt_sim -ll:cpu 1 -ll:gpu 3 -ll:dma 2 -ll:zsize 1536 -ll:fsize 1024 -ll:csize 4096 -ll:gsize 1536 -npp 2500 -wpp 16384 -p 96 -l 10 -level 3 -sync 1 1> ckt_sim_96_16_1_3.stdio 2> ckt_sim_96_16_1_3.stderr 
...
GASNET_BACKTRACE=1 gasnetrun_ibv -n 32 /nics/d/home/sequoia/mike_legion/region/apps/circuit/ckt_sim -ll:cpu 1 -ll:gpu 3 -ll:dma 4 -ll:zsize 1536 -ll:fsize 1024 -ll:csize 4096 -ll:gsize 1536 -npp 2500 -wpp 16384 -p 96 -l 10 -level 3 -sync 1 1> ckt_sim_96_32_1_3.stdio 2> ckt_sim_96_32_1_3.stderr 
