...
//--------------------------------------------------------------------------------------------
{
  ...
  {
    log_sequoia(LEVEL_DEBUG,"No prior instances for region %d on processor %x",
  ...
  else
  {
    ...
    log_sequoia(LEVEL_DEBUG,"Closest instance for region %d is memory %d on processor %x",
